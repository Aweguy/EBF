...
{
    abstract public class OreNPC : ModNPC
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            if ((NPC.type != ModContent.NPCType<AmethystOre>() && NPC.type != ModContent.NPCType<RubyOre>() && NPC.type != ModContent.NPCType<TopazOre>() && NPC.type != ModContent.NPCType<ZirconOre>()) && spawnInfo.Player.ZoneRockLayerHeight && !spawnInfo.Invasion)
            {
                return 0.02f;
            }
