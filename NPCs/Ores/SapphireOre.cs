...
namespace EBF.NPCs.Ores
{
    public class SapphireOre : OreNPC
	{
		...
		{
			base.DisplayName.WithFormatArgs("Sapphire Ore");
		...
		public override void SetSafeDefaults()
		{
			...
			Explosion = ModContent.ProjectileType<SapphireOre_SapphireExplosion>();
	...
	public class SapphireOre_SapphireExplosion : ModProjectile
	{
        public override void SetStaticDefaults()
        {
