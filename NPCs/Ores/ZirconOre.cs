...
namespace EBF.NPCs.Ores
{
    public class ZirconOre : OreNPC
    {
        ...
        {
            base.DisplayName.WithFormatArgs("Zircon Ore");
        ...
        public override void SetSafeDefaults()
        {
            ...
            Explosion = ModContent.ProjectileType<ZirconOre_ZirconExplosion>();
    ...
    public class ZirconOre_ZirconExplosion : ModProjectile
    {
        public override void SetStaticDefaults()
        {
