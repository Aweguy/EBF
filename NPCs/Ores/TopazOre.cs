...
namespace EBF.NPCs.Ores
{
    public class TopazOre : OreNPC
    {
        ...
        {
            base.DisplayName.WithFormatArgs("Topaz Ore");
        ...
        public override void SetSafeDefaults()
        {
            ...
            Explosion = ModContent.ProjectileType<TopazOre_TopazExplosion>();
    ...
    public class TopazOre_TopazExplosion : ModProjectile
    {
        public override void SetStaticDefaults()
        {
