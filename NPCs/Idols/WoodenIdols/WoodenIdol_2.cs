...
{
    public class WoodenIdol_2 : Idol
    {
        ...
        {
            base.DisplayName.WithFormatArgs("Wooden Idol 2");
        }
        ...
        {
            int goreIndex = Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * NPC.direction, Mod.Find<ModGore>("WoodenIdol2_Gore1").Type, 1f);
            int goreIndex2 = Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity * NPC.direction * -1, Mod.Find<ModGore>("WoodenIdol2_Gore2").Type, 1f);
