...
namespace EBF.NPCs.Bosses.Godcat
{
    ...
    public class Godcat_Dark : Godcat
    {
        ...
        private void CreateDarkStreamBall(Player player, float speed, float deviation)
        {
            ...
            var proj = Projectile.NewProjectileDirect(NPC.GetSource_FromAI(), NPC.Center, velocity, type, NPC.damage / 2, 3f, -1, (int)GodcatBallTypes.DarkBig);
        ...
        private void CreateDarkReturnBall(Player player, float speed)
        {
            ...
            Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center, NPC.DirectionTo(player.Center) * speed, type, NPC.damage / 2, 3f, -1, (float)GodcatBallTypes.DarkBig, NPC.whoAmI);
