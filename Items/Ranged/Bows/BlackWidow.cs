...
{
    public class BlackWidow : EBFBow, ILocalizedModType
    {
        public new string LocalizationCategory => "Items.Weapons.Ranged.Bows";
        protected override int HoldoutProjectile => ModContent.ProjectileType<BlackWidow_HoldoutProjectile>();
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 44;//Item's base damage value
    ...
    public class BlackWidow_HoldoutProjectile : EBFHoldoutBow
    {
        protected override int ArrowType => ModContent.ProjectileType<BlackWidow_Arrow>();
        public override string Texture => "EBF/Items/Ranged/Bows/BlackWidow";
        public override void SetDefaults()
        {
            Projectile.width = 32;
    ...
    public class BlackWidow_Arrow : ModProjectile
    {
