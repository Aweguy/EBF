...
{
    public class CrimsonDragon : EBFBow, ILocalizedModType
    {
        public new string LocalizationCategory => "Items.Weapons.Ranged.Bows";
        protected override int HoldoutProjectile => ModContent.ProjectileType<CrimsonDragon_HoldoutProjectile>();
    ...
    public class CrimsonDragon_HoldoutProjectile : EBFHoldoutBow
    {
        protected override int ArrowType => ModContent.ProjectileType<CrimsonDragon_CrimsonArrow>();
        public override string Texture => "EBF/Items/Ranged/Bows/CrimsonDragon";
