...
{
    public class ShadowBlaster : EBFGun, ILocalizedModType
    {
        public new string LocalizationCategory => "Items.Weapons.Ranged.Guns";
        public override void SetDefaults()
        {
            base.SetDefaults();
            launcherType = ModContent.ProjectileType<ShadowBlasterLauncher>();
            sidearmType = ModContent.ProjectileType<ShadowBlasterSidearm>();
            overheatTime = 60 * 15;
