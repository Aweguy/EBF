...
{
    public class QuakeMaker : EBFGun, ILocalizedModType
    {
        public new string LocalizationCategory => "Items.Weapons.Ranged.Guns";
        public override void SetDefaults()
        {
            base.SetDefaults();
            launcherType = ModContent.ProjectileType<QuakeMakerLauncher>();
            sidearmType = ModContent.ProjectileType<QuakeMakerSidearm>();
            overheatTime = 60 * 6;
    ...
    public class QuakeMakerLauncher : EBFMagicLauncher
    {
        ...
        public override void OnGroundHit()
        {
            ...
            NPC target = new();
            if (EBFUtils.ClosestNPC(ref target, 400, Projectile.Center, ignoreTiles: true))
            {
