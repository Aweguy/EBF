...
{
    public class SteelShark : EBFGun, ILocalizedModType
    {
        public new string LocalizationCategory => "Items.Weapons.Ranged.Guns";
        public override void SetDefaults()
        {
            base.SetDefaults();
            launcherType = ModContent.ProjectileType<SteelSharkLauncher>();
            sidearmType = ModContent.ProjectileType<SteelSharkSidearm>();
            overheatTime = 60 * 15;
